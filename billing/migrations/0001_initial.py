# Generated by Django 3.1.4 on 2020-12-09 03:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ordertype', models.CharField(choices=[('B', 'BUY'), ('S', 'SELL')], max_length=1)),
                ('orderid', models.CharField(max_length=21, unique=True)),
                ('date', models.DateField(auto_now_add=True, null=True)),
                ('customer', models.ForeignKey(null=True, on_delete=models.SET(billing.models.get_sentinel_customer), to='billing.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=models.SET(billing.models.get_sentinel_product), to='billing.product')),
        ...
        migrations.AddField(
            model_name='order',
            name='products',
            field=models.ManyToManyField(through='billing.OrderItem', to='billing.Product'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
